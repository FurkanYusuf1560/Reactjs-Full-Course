    ...
    <Fragment>
      ...
      <div className="col-span-2 flex items-start gap-4">
        ...
        <div>
          ...
          <button onClick={()=> handleRemoveFromCart(singleCartItem, true)} className="text-gray-100 bg-red-700">Remove</button>
        </div>
      </div>
      <div className="ml-auto">
        ...
        <div className="mt-3">
          <button   disabled={singleCartItem?.quantity === 1} onClick={()=> handleRemoveFromCart(singleCartItem, false)}>-</button>
